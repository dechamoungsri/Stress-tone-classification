...
def run_latent_data(base_path, trn_data, tst_data, outpath, name, fold):
    ...
    trndata = ANN_Executioner_Helper.get_latent_data(base_path, trn_data['name_index'], trn_data['tone'], use_input_sensitivity=True, normalize=False)
    tstdata = ANN_Executioner_Helper.get_latent_data(base_path, tst_data['name_index'], tst_data['tone'], use_input_sensitivity=True, normalize=False)
