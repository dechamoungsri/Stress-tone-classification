...
def gen(syl_object_path):
    ...
    for syl in syllable_management.syllables_list:
        ...
        syl.gen_tonal_part_training_feature(
            Syllable.Training_feature_tonal_part_raw_remove_head_tail_having_missing, 
...
if __name__ == '__main__':
    ...
    syl_object_path = '/home/h1/decha/Dropbox/Inter_speech_2016/Syllable_object/GPR-data-work-space/gpr_syllable_obj/Syllable_object.pickle'
