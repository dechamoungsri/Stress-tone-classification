...
if __name__ == '__main__':
    ...
    base_path_list = [
       # '/work/w13/decha/Inter_speech_2016_workplace/Tonal_projection/06_Tonal_part_projection_noise_reduction-250-iters-opt/',
        # '/work/w13/decha/Inter_speech_2016_workplace/Tonal_projection/09_25lf0_to_compare_with_ann/'
        '/work/w13/decha/Inter_speech_2016_workplace/Tonal_projection/09b_25lf0_fix_some_500_max_iters'
        ]
    ...
    name_in_figure = 'LABEL_TYPE_STRESS_SEP_GPR'
            ...
            for dims in input_dims:
                ...
                for d in Utility.list_file(delta_path):
                    ...
                    for tone in Utility.list_file('{}/{}/'.format(delta_path, d)):
                        ...
                        plot_type(
                            GP_LVM_Scatter.LABEL_TYPE_STRESS_SEP_GPR, 
                            outpath, 
                            tone_path, 
                            object_data)
